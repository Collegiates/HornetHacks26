...
| PATCH | `/api/account/profile` | User | Update profile fields owned by the backend |
| POST | `/api/account/face-profile` | User | Upload enrollment selfie data and update face profile state |
